                    ...
                    <div className={styles.contentBox}>
                        <div className={styles.medicine}>
                            ...
                            <div className={styles.left}>
                                ...
                                <div className={styles.rows}>
                                    ...
                                    <h3>(영어: depressants, anesthetic)
                                    </h3>
                                </div>
                                <div className={styles.textBox}>
                                    <p>일반적인 진정, 최면, 마취 등 중추신경계를 억제하여 작용을 떨어트리는 약물로, 진정과 마취효과를 통해 수면을 유도하고 긴장을 완화시키는 약물입니다.
                                    </p>
                                </div>
                        ...
                        <div className={styles.effect}>
                            ...
                            <div className={`${styles.effectsContent} ${showEffects ? styles.show : ''}`}>
                                <ul>
                                    <li>벤조디아제핀계 약물은 졸림, 기억력 감퇴, 어지럼증, 두통, 변비, 과민성 등이 흔한 부작용으로 알려져 있고 식욕 변화, 시야 흐림, 악몽 등이 간혹 나타나기도 합니다. 또한 장기간 투여 시 의존성 위험이 증가합니다. </li>
                                    <li>
                                        비-벤조디아제핀계 약물은 졸음, 두통, 어지러움, 불면증 악화, 인지장애, 호흡기 감염 등이 발생하며 의존성은 벤조디아제핀계열 대비 낮은 편 입니다.</li>
